...
<link rel="stylesheet" href="https://kit.fontawesome.com/f7c161e92f.css" crossorigin="anonymous">
  </head>
  <body>
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="dropdown1" data-toggle="dropdown" aria-expanded="true">Gestion des genres</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="listeNatio.php">Liste des nationalités</a>
          <a class="dropdown-item" href="formAjoutNatio.php">Ajouter une nationalités</a>
        </div>
      </li>
    </ul>
  </div>
